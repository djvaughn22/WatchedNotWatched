...
export const SAMPLE_CATALOG: MediaTitle[] = [
  ...
  {
    id: "sample:skeleton-dance",
    source: "sample",
    sourceId: "skeleton-dance",
    mediaType: "movie",
    title: "The Skeleton Dance",
    releaseYear: 1929,
    synopsis:
      "The first Silly Symphony: four skeletons rise from a graveyard at midnight and dance until dawn. Comedy-horror with spooky imagery throughout. Public domain in the United States since January 1, 2025. Streams from the Internet Archive with a WatchedNotWatched filter track.",
    officialRating: "NR",
    genres: ["Animation", "Comedy", "Horror", "Short"],
    guidance: notReviewedGuidance([...ALL_CATEGORIES]),
    availability: [],
    attribution: [
      { source: "Internet Archive", text: "The Skeleton Dance (1929) — US public domain. Video hosted by the Internet Archive.", url: "https://archive.org/details/videoplayback-5_20260207" },
    ],
    dataStatus: "sample",
  },
